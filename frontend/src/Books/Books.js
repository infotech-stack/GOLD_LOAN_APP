        ...
        switch (id) {
          ...
          case "heading15":
            return (
              <Typography className="font-tamil">
                {" "}
                அடமானக் கையொப்பம் அல்லது இடது கட்டைவிரல்
              </Typography>
            );
          case "heading16":
            return (
        ...
        switch (id) {
          ...
          case "addressLine2":
            ...
            case "condition":
              return (
                <Typography className="font_book">
                  1. The loan amount will be disbursed as per the terms and conditions.
                  2. Interest will be charged as per the agreement.
                  3. Any delay in repayment will incur penalties.
                  4. The borrower should provide necessary documents as required.
                  5. The loan is subject to approval by the management.
                </Typography>
              );
            case "heading1":
              return (
                <Typography className="font_book">
                  1. Your interest is determined by adding value to the property you are pledging.
                </Typography>
              );
            case "heading2":
              return (
                <Typography className="font_book">
                  2. To return the jewelry within one year / six months from the date of pledge or to renew with interest, failing which the interest rate of your jewelry loan will change in the following days. In case of further failure, the jewels will be auctioned.
                </Typography>
              );
            case "heading3":
              return (
                <Typography className="font_book">
                  3. All postage and other expenses sent to the mortgagee will be credited to their loan account.
                </Typography>
              );
            case "heading4":
              return (
                <Typography className="font_book">
                  4. I / We hereby declare that all the jewelry which I / we are bringing to your company for pawning is my / our own jewelry.
                </Typography>
              );
            case "heading5":
              return (
                <Typography className="font_book">
                  5. If there is any change in your address and phone number, you should inform the management immediately. Management will not be held responsible in case of failure.
                </Typography>
              );
            case "heading6":
              return (
                <Typography className="font_book">
                  6. In case of loss of the jewelry loan receipt, I agree to provide the certificates requested by the management.
                </Typography>
              );
            case "heading7":
              return (
                <Typography className="font_book">
                  7. In case of a fall in the price of gold, I will immediately repay the amount demanded by management. In case of a mistake, I wholeheartedly consent to the management's decision on my jewelry. I fully agree to the above conditions.
                </Typography>
              );
            case "heading8":
              return (
            ...
            case "heading9":
              return (
                <Typography className="font_book">
                  *The jewelry can only be returned if the owner comes with this receipt when returning the jewelry.
                </Typography>
              );
            case "heading10":
              return (
            ...
            case "heading17":
              return (
                <Typography className="font_book">
                  Office Hours: 9:00 AM to 6:00 PM. Closed on Sundays and major festivals.
                </Typography>
              );
          case "schema":
            ...
            <Grid item xs={12}>
              <TableContainer>
                <Table>
                  <TableHead>
                    <TableRow>
                      <TableCell sx={{ border: "1px solid black" }} colSpan={2}>
              ...
              <TableContainer sx={{ mt: 1, height: "390px" }}> {/* Adjust this height as needed */}
  <Table>
    <TableRow>
      {/* Customer Photo */}
      <TableCell
      ...
      <div style={{ padding: "20px", marginTop: "40px" }} className="billbooks">
        <Paper
          elevation={2}
          style={{ padding: "20px" }}
          sx={{ maxWidth: 750, margin: "auto" }}
